                    ...
                    <div className="col-12 col-md-6">
                        <div className=" ">
                            ...
                            <div className="sect-para text-justify">
                                <p className=" fw-semibold fs-5">Need assistance? Our dedicated customer support team is here to help. Whether you have questions, feedback, or need assistance with an order, our friendly team is ready to assist you. You can reach us via phone, email, or through our convenient online contact form. Reach out to us today and experience exceptional customer service at SpeedyFuel.</p>
                            </div>
                        </div>
                    </div>
