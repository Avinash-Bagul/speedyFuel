...
const Navbar = () => {
    const { loginUser, isLogin } = useGlobalLoginData();
    ...
    return (
        <>
            <nav className="navbar navbar-expand-lg navbar-light nav-bg navcss w-100 shadow" id="fixed-nav">
                <div className="container">
                    <NavLink className="navbar-brand d-flex" href="#">
                        <p className="text-orange fw-bold">SpeedyFuel</p>
                    </NavLink>
                    <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                        <span className="navbar-toggler-icon"></span>
                    </button>
                    <div className="collapse navbar-collapse w-400px flex-grow-0 nav-mobile" id="navbarSupportedContent">
